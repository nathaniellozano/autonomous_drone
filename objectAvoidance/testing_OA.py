...
def adjust_tello_position(offset_x, offset_y, offset_z):
    ...
    will try to get it to dodge a specified distance but for now I just want it to dodge then center
    """
    ...
    if not -90 <= offset_x <= 90 and offset_x is not 0:
        if offset_x < 0:
            dodge_right_center(50)
            #center= 1
            #move=1
        elif offset_x > 0:
            dodge_left_center(50)
            #center= 1
            #move=2
        else:
            dodge_left_center(50)
...
while True:
    ...
    # draw a bounding box around the image and display it
        ...
        #some testing that hasn't been testing
        #moved1==True
        #c+=1
